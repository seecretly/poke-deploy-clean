...
Determine:
1. Task type (email, calendar, search, trigger, integration, other)
...
{{
    "task_type": "email|calendar|search|trigger|integration|other",
    "action": "send|compose|search|create|delete|update|schedule|remind",
    "parameters": {{
